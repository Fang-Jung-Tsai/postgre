...
class user_argument:
    ...
    def get_last_folder():
        ...
        #last folder name must be LILY or ROSA
        if folder_name != 'LILY' and folder_name != 'ROSA':
            raise Exception('The last folder name of the current file path must be LILY or ROSA')
        
        #the last folder name is in user's home named LILY_ROOT or ROSA_ROOT
        folder_name =  os.path.join(os.path.expanduser("~"), folder_name + '_ROOT')
