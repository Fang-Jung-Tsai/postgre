...
class file:
    ...
    def __init__(self, file_path):
        ...
        self.file_name_length = len(self.file_name) if self.file_name else 0
        self.file_path = file_path
        self.file_path_length = len(self.file_path) if self.file_path else 0    
    ...
    def calculate_directory_files_info(directory_path):
        ...
        info_func = partial(process_object, func=file.get_info)
